...
curl -sS https://raw.githubusercontents.com/gfwlist/gfwlist/master/gfwlist.txt | \
...
curl -sS https://raw.githubusercontents.com/hq450/fancyss/master/rules/gfwlist.conf | \
  sed 's/ipset=\/\.//g; s/\/gfwlist//g; /^server/d' > /tmp/temp_gfwlist2

curl -sS https://raw.githubusercontents.com/Loyalsoldier/v2ray-rules-dat/release/gfw.txt > /tmp/temp_gfwlist3
